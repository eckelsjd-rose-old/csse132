...
handleLocalInput(struct db_entry** db)
{
  ...
  const char* instructions = " (a)dd, (l)ist, (i)mport, (e)xport, (i)mport, (r)emove, (f)ind or (q)uit\n";
  char buf[512];
  char buf2[512];
  ...
  for( ;; ) {
    ...
    case 'f': // FIND
      // DONE:  This is part 6 of the lab (and is optional for this lab).  You'll need
